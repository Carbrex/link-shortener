...
function ErrorAndRedirect() {
  ...
  const shortUrl =
    url.split(window.location.origin)[1].charAt(0) === "/"
      ? url.split(window.location.origin)[1].slice(1)
        ...
        <div className="container px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
          <div className="wf-ull lg:w-1/2">
            ...
            <div className="flex items-center mt-6 gap-x-3">
              ...
              <Link to={"/dashboard"} className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                Take me home
              </Link>
            </div>
          </div>
